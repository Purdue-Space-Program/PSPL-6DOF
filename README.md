...
Activate it when running Python commands directly:

```bash
source .venv/bin/activate
```

MATLAB scripts that configure `pyenv`, such as `Copperhead.m`, use `.venv` directly and do not require shell activation.
