classdef RocketGUI_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ComponentSelectionDropDownLabel.HorizontalAlignment = 'right';
            app.ComponentSelectionDropDownLabel.WordWrap = 'on';
            app.ComponentSelectionDropDownLabel.Layout.Row = 2;
            ...
            app.ComponentSelectionDropDown.Layout.Row = 2;
            ...
            app.UIAxes.Position = [12 267 396 199];
